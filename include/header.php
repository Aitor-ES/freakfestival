<header class="navbar navbar-expand-lg sticky-top ff-navbar" data-bs-theme="dark">
  <nav id="header-nav" class="container-xxl">
    <button id="navbar-toggler-header" class="navbar-toggler p-2 border-0 shadow-none" type="button"
      data-bs-toggle="offcanvas" data-bs-target="#header-offcanvas" aria-controls="header-offcanvas"
    ...
    <button id="navbar-toggler-footer" class="navbar-toggler d-lg-none p-2 border-0 shadow-none" type="button"
      data-bs-toggle="offcanvas" data-bs-target="#footer-offcanvas" aria-controls="footer-offcanvas"
    ...
    <div class="offcanvas offcanvas-start bg-ffscarlet bg-gradient d-lg-contents flex-grow-1" tabindex="-1"
      ...
      <div class="offcanvas-header text-light px-4 pb-0">
        ...
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
          data-bs-target="#header-offcanvas" aria-label="Close"></button>
      </div>
          ...
          <ul class="navbar-nav nav-justified flex-grow-1">
            ...
            <li class="nav-item dropdown">
              ...
              <?php echo in_array($curPageName, ["index", "photos", "posters", "hotels", "maps", "organizers", "contributors", "inscripciones-candidaturas"])
                ...
                : "fw-semibold"; ?>" href="#" id="navbarDropdown-festival" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
              ...
              <ul class="dropdown-menu" data-bs-theme="light" aria-labelledby="navbarDropdown-festival">
                ...
                <li>
                  <a class="dropdown-item" href="/<?php echo $links[$lang["lang"] . ".hotels"]; ?>.php">
                    <?php echo $lang["lang.header.hotels"]; ?>
                  </a>
                </li>
                <li>
