      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 g-5">
        ...
        <div class="col">
          <div class="h-100 bg-ffscarlet-10 bg-gradient rounded-4 p-4">
            ...
            <a class="btn btn-outline-ffscarlet rounded-pill" href="/<?php echo $links["$lang[lang].contests"]; ?>.php">
        ...
        <div class="col">
          <div class="h-100 bg-ffscarlet-10 bg-gradient rounded-4 p-4">
            ...
            <a class="btn btn-outline-ffscarlet rounded-pill" href="/<?php echo $links["$lang[lang].stands"]; ?>.php">
        ...
        <div class="col">
          <div class="h-100 bg-ffscarlet-10 bg-gradient rounded-4 p-4">
            ...
            <a class="btn btn-outline-ffscarlet rounded-pill" href="/<?php echo $links["$lang[lang].guests"]; ?>.php">
