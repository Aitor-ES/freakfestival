        ...
        <li class="list-group-item">
          <div class="row justify-content-center gy-4 gx-5">
            ...
            <div class="col-12 col-lg-4 d-flex justify-content-center align-items-start">
              <img class="guest-logo rounded-5" src="/images/contributors/<?php echo $guest->logo; ?>" alt="<?php echo $lang["lang.activities.$curPageName.$guest->activityName.title"]; ?>" width="400" height="400">
            </div>

            <!-- Activity main content -->
            <div class="col-12 col-lg-6">
              <!-- Activity title -->
              <h2 id="<?php echo $guest->activityName; ?>">
                <?php echo $lang["lang.activities.$curPageName.$guest->activityName.title"]; ?>
                <a class="anchor-link" href="#<?php echo $guest->activityName; ?>" aria-label="Link to this section: <?php echo $lang["lang.activities.$curPageName.$guest->activityName.title"]; ?>"></a>
              </h2>

              <!-- Activity type -->
              <p class="lead text-ffscarlet"><?php echo $lang["lang.activities.$curPageName.$guest->activityName.dedication"]; ?></p>

              <!-- Activity description -->
              <p><?php echo $lang["lang.activities.$curPageName.$guest->activityName.description.1"]; ?></p>
              <p><?php echo $lang["lang.activities.$curPageName.$guest->activityName.description.2"]; ?></p>
