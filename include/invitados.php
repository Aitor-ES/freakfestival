          ...
          <li class="list-group-item">
            <div class="row justify-content-center g-5">
              ...
              <div class="col-12 col-lg-4 d-flex justify-content-center align-items-start">
                <img class="guest-logo rounded-5" src="/images/contributors/<?php echo $guest->logo; ?>"
                  alt="<?php echo $lang["lang.activities.$curPageName.$guest->name.title"]; ?>" width="300" height="300">
              </div>
              ...
              <div class="col-12 col-lg-6">
                ...
                <h2 id="<?php echo $guest->name; ?>">
                  ...
                  <a class="anchor-link" href="#<?php echo $guest->name; ?>"
                    aria-label="Link to this section: <?php echo $lang["lang.activities.$curPageName.$guest->name.title"]; ?>"></a>
                </h2>

                <!-- Activity type -->
                <p class="lead text-ffscarlet">
                  <?php echo $lang["lang.activities.$curPageName.$guest->name.dedication"]; ?>
                </p>
