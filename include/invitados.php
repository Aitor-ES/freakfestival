        ...
        <li class="list-group-item">
          <div class="row justify-content-center gy-4 gx-5">
            ...
            <div class="col-12 col-lg-6">
              ...
              <!-- Activity type -->
              <p class="lead text-ffscarlet"><?php echo $lang["lang.activities.$categoryName.$activity->activityName.dedication"]; ?></p>

              <!-- Activity description -->
              <p><?php echo $lang["lang.activities.$categoryName.$activity->activityName.description.1"]; ?></p>
              <p><?php echo $lang["lang.activities.$categoryName.$activity->activityName.description.2"]; ?></p>
              ...
              <ul class="list-inline">
                ...
                <?php if (property_exists($activity, 'discord')) { ?>
                  <li class="list-inline-item"><a class="icon-btn btn btn-lg btn-outline-ffscarlet" href="<?php echo $activity->x; ?>" target="_blank"><i class="bi bi-discord"></i></a></li>
                <?php } ?>
              </ul>
            </div>
          </div>
