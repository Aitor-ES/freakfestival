<body>
  ...
  <div class="container-md ff-main-gutter my-5">
    <h1 class="f-uncial-r mb-5"><?php echo $lang["lang.activities.board-games.title"]; ?></h1>

    <?php $activityCategory = json_decode(file_get_contents(__DIR__ . '/actividades-2023.json'))[0]; ?>
