<body>
  ...
  <main class="container-md ff-gutter my-4 my-md-5">
    ...
    <?php } else { ?>
      <!-- Filters Start -->
      <div class="accordion mb-5" id="accordion-filters">
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapse-filters" aria-expanded="false" aria-controls="collapse-filters">
              <i class="bi bi-search fs-2 text-ffscarlet me-3"></i><?php echo $lang["lang.activities.filters.title"]; ?>
            </button>
          </h2>
          <div id="collapse-filters" class="accordion-collapse collapse">
              ...
              <ul class="filters list-group list-group-flush">
                ...
                <li class="list-group-item">
                  ...
                  <ul class="nav nav-pills pills-tab column-gap-2 row-gap-3" id="pills-type-tab" role="tablist">
                    <li role="presentation">
                      <button class="btn btn-outline-ffscarlet btn-sm active" id="pills-type-all-tab"
                ...
                <li class="list-group-item">
                  ...
                  <ul class="nav nav-pills pills-tab column-gap-2 row-gap-3" id="pills-date-tab" role="tablist">
                    <li role="presentation">
                      <button class="btn btn-outline-ffscarlet btn-sm active" id="pills-date-all-tab"
                        data-bs-toggle="pill" type="button" role="tab" aria-selected="true"
                ...
                <li class="list-group-item">
                  ...
                  <ul class="nav nav-pills pills-tab column-gap-2 row-gap-3" id="pills-lang-tab" role="tablist">
                    <li role="presentation">
                      <button class="btn btn-outline-ffscarlet btn-sm active" id="pills-lang-all-tab"
                        data-bs-toggle="pill" type="button" role="tab" aria-selected="true"
          ...
          foreach ($activity->lang as $activityLang) {
            ...
            <div class="row justify-content-center g-5">
              ...
              <div class="col-12 col-lg-6">
                ...
                <!-- Activity info -->
                <div class="row row-cols-2 row-cols-sm-3 row-cols-lg-2 row-cols-xl-3 g-3 mb-4">
                  <!-- Activity type -->
                  <div class="col">
                    <div
                      class="d-flex align-items-center column-gap-3 h-100 bg-ffscarlet-10 bg-gradient rounded-4 py-1 px-3">
                  ...
                  <div class="col">
                    <div
                      ...
                      else if ($activity->age == ["teenagers", "adults"])
                        echo $lang["lang.activities.age.teenagers-adults"];
                      else
                ...
                <p class="mb-0"><?php echo $activityDescription; ?></p>

                <!-- Activity links -->
                <?php if (property_exists($activity, 'rules') || property_exists($activity, 'register')) { ?>
                  <div class="row gy-3">
              ...
              <div class="col-12 col-lg-3">
                <div class="row row-cols-2 row-cols-lg-1 justify-content-center align-items-center gy-4">
                  ...
                  <?php if (property_exists($activity, 'organizer')) { ?>
                    <div class="col d-flex flex-column row-gap-2 text-lg-center">
