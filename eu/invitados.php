...
<html lang="eu">
  ...
  <body>
    ...
    <div class="container-md ff-main-gutter my-5">
      <h1 class="f-uncial-r mb-5">Gonbidatuak</h1>
        ...
        <div class="col">
          <div class="card h-100 bg-ffmidnight-75 text-white border-0 rounded-5">
            ...
            <div class="card-body">
              ...
              <p class="card-text">7 urte daramatza iadanik cosplay munduan, eta bideojokoetako pertsonaiak eta xehetasun askoko armadurak ditu gogokoen, akabera oso errealista eta organikoekin. Oso pozik gaude Freak Festival honetan gurekin edukitzeaz.
                Animatzen al zarete pasa eta ezagutzera?</p>
            </div>
        ...
        <div class="col">
          <div class="card h-100 bg-ffmidnight-75 text-white border-0 rounded-5">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Kantabriatik dator, 2014tik duen pasioa erakustera; pertsonaien karakterizazioa, batez ere makillajeari eta ehungintzari dagokienez.
                Pozten gara gure artean izateaz aurten, anima zaitezte etortzera eta ezagutzera!</p>
            </div>
        ...
        <div class="col">
          <div class="card h-100 bg-ffmidnight-75 text-white border-0 rounded-5">
            ...
            <div class="card-body">
              ...
              <p class="card-text">2017tik darama eszenatokien gainean, eta Bizkaiko, Kantabriako eta Asturiaseko hainbat cosplay lehiaketa irabazi ditu.
                Lehiaketetan erabiltzen duen atrezzoa diseinatzea gustoko du, baita ileordeak estilizatzea eta armadurak eta ehun-cosplayak egitea ere.
                Ekitaldian eduki eta bere esperientzietatik ikasteko irrikan gaude, animatu zaitezte zuek ere!</p>
            </div>
